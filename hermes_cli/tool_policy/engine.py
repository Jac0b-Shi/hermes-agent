...
This module is called from ``model_tools._execute_tool._dispatch()`` as the
last gate before ``registry.dispatch()`` (final args after every middleware
rewrite).  It is NOT a plugin and cannot be disabled or unloaded.
